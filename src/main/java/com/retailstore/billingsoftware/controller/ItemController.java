...
import com.retailstore.billingsoftware.service.ItemService;
    ...
    public ItemResponse addItem(@RequestPart("item") String itemString ,
        ...
        try{
          ...
          return itemService.add(itemRequest, file);
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Error ourred while processing the json");
        }
    }
